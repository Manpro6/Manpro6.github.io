    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          <li><a href="<?php echo base_url('index.php/gambar')?>" style="color:white; font-size:12pt;">Gambar</a></li> 
          <li><a href="<?php echo base_url('kursus')?>" style="color:white; font-size:12pt;">Kursus</a></li>    
          <li><a href="<?php echo base_url('sertifikasi')?>" style="color:white; font-size:12pt;">Sertifikasi</a></li>
          <li><a href="<?php echo base_url('tentang')?>" style="color:white; font-size:12pt;">Tentang</a></li>             
        </ul>
      </div>
    </div>
  </nav>
